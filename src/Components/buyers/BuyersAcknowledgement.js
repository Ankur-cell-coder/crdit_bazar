...
function BuyersAcknowledgement(props) {
  ...
  return (
    <BuyersAcknowledgement1>
      <div className='acknowl'>
        <h5>Acknowledgement buyers</h5>
      </div>
...
export default BuyersAcknowledgement;

const BuyersAcknowledgement1 = styled.div`
